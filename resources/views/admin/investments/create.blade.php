...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-slate-600 dark:text-slate-300">New Investment Application</span>
        </nav>
    </div>

    <div class="card shadow-md rounded-xl">
        <div class="card-header bg-slate-100 dark:bg-slate-800 px-6 py-4">
            <h4 class="card-title">Create Investment Application</h4>
        </div>
            ...
            <form action="{{ route('investments.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="business_name" id="business_name" class="form-control mt-1" required>
                    </div>
                    <div>
                        <label for="owner_name" class="block text-sm font-medium text-slate-700 dark:text-slate-300">Owner
                            Name</label>
                        <input type="text" name="owner_name" id="owner_name" class="form-control mt-1" required>
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="business_address" id="business_address" rows="3" class="form-control mt-1" required></textarea>
                    </div>
                    <div>
                        <label for="business_type"
                            class="block text-sm font-medium text-slate-700 dark:text-slate-300">Business Type</label>
                        <input type="text" name="business_type" id="business_type" class="form-control mt-1" required>
                    </div>
                </div>
